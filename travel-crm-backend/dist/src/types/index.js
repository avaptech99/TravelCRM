...
exports.createBookingSchema = zod_1.z.object({
    ...
    segments: zod_1.z.array(zod_1.z.object({
        ...
        departureDate: zod_1.z.string().optional().nullable(),
...
exports.updateBookingSchema = zod_1.z.object({
    ...
    travelDate: zod_1.z.any().optional(),
    returnDate: zod_1.z.any().optional(),
    flightFrom: zod_1.z.any().optional(),
    flightTo: zod_1.z.any().optional(),
    tripType: zod_1.z.any().optional(),
    destination: zod_1.z.any().optional(),
    amount: zod_1.z.any().optional(),
    travellers: zod_1.z.any().optional(),
    pricePerTicket: zod_1.z.any().optional(),
    includesFlight: zod_1.z.any().optional(),
    includesAdditionalServices: zod_1.z.any().optional(),
    contactEmail: zod_1.z.any().optional(),
});
