...
export const Bookings: React.FC = () => {
    ...
    const activeFilterCount = selectedStatuses.length + (selectedAgent ? 1 : 0);
                ...
                <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-4 mx-2 space-y-4">
                    ...
                    {isAdmin && (
                        <div className="flex items-center gap-3 pt-2 border-t border-slate-100">
                            <label className="text-xs font-bold text-slate-500 uppercase tracking-wider whitespace-nowrap">Agent</label>
                            <select
                                value={selectedAgent}
