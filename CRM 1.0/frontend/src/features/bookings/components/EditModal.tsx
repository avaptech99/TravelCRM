                    ...
                    {!isMarketer && (
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <div className="flex p-1 bg-slate-100 rounded-xl w-full h-[42px]">
                                    <button
                                        type="button"
                                        onClick={() => setInterested('Yes')}
                                        className={`flex items-center justify-center gap-2 flex-1 rounded-lg text-xs font-bold transition-all duration-200 ${
                                            interested === 'Yes'
                                                ? 'bg-emerald-500 text-white shadow-lg scale-[1.02]'
                                                : 'text-slate-500 hover:bg-slate-200'
                                        }`}
                                    >
                                        <ThumbsUp className={`w-3 h-3 ${interested === 'Yes' ? 'animate-bounce' : ''}`} />
                                        Yes
                                    </button>
                                    <button
                                        type="button"
                                    ...
                                    >
                                        <ThumbsDown className={`w-3 h-3 ${interested === 'No' ? 'animate-bounce' : ''}`} />
                                        No
                                    </button>
                                </div>
                            </div>
