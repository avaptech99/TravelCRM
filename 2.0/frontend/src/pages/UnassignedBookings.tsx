...
export const UnassignedBookings: React.FC = () => {
    ...
    return (
        <div className="space-y-4">
            <div className="flex flex-col md:flex-row md:justify-between items-start md:items-center gap-4 md:gap-0 px-2">
                <div>
                    <h1 className="text-2xl font-bold text-slate-900 whitespace-nowrap">Unassigned Bookings</h1>
                    <p className="text-slate-500 text-sm mt-1">Bookings that haven't been assigned to any agent yet.</p>
                </div>
