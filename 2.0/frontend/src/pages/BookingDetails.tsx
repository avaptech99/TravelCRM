...
import { ArrowLeft, User, Phone, Mail, Calendar, MapPin, MessageSquare, Clock, Plane, Edit2, CreditCard, Plus, UserPlus, Building2, UserCircle, List, Users, ShieldCheck, Check, RotateCcw, ArrowLeftRight, Maximize2, X } from 'lucide-react';
                    ...
                    >
                        ...
                        <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
                            <div className="flex items-center gap-2">
                                ...
                                <div>
                                    <h2 className="text-lg font-bold text-slate-900">Comments & Activity</h2>
                                    <p className="text-xs text-slate-500 font-medium">History for {booking.contactPerson}</p>
                                </div>
                            </div>
                            <button 
                        ...
                        <div className="flex-1 overflow-y-auto p-6 space-y-6">
                            ...
                            <div className="space-y-4">
                                <h3 className="text-xs font-bold text-slate-400 uppercase tracking-[0.2em] px-1">Activity Feed</h3>
                                {booking.comments && booking.comments.length > 0 ? (
                                    booking.comments.sort((a: any, b: any) => new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime()).map((comment: any) => (
                                        <div key={comment.id} className="relative pl-6 pb-2 border-l-2 border-slate-100 last:border-0 last:pb-0">
                                            ...
                                            <div className="bg-slate-50/50 hover:bg-slate-50 p-4 rounded-2xl border border-slate-100 transition-colors">
                                                <div className="flex justify-between items-start mb-2">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <span className="text-sm font-bold text-slate-800">{comment.createdBy?.name}</span>
                                                    </div>
