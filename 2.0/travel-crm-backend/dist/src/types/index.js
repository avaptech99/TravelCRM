...
exports.createUserSchema = zod_1.z.object({
    ...
    permissions: zod_1.z.object({
        leadVisibility: zod_1.z.enum(['all', 'own', 'none']).optional(),
        canAssignLeads: zod_1.z.boolean().optional(),
        canEditActualCost: zod_1.z.boolean().optional(),
        canVerifyBookings: zod_1.z.boolean().optional(),
        canManageUsers: zod_1.z.boolean().optional(),
        canViewReports: zod_1.z.boolean().optional(),
        featureAccess: zod_1.z.object({
            visa: zod_1.z.boolean().optional(),
            ticketing: zod_1.z.boolean().optional(),
            operation: zod_1.z.boolean().optional(),
