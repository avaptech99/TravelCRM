...
exports.getQueryGrouping = exports.getPaymentBreakdown = exports.getAgentAnalytics = exports.getRevenueTrends = exports.getPaymentAnalytics = exports.getBookingAnalytics = void 0;
...
// @access  Private/Admin
exports.getQueryGrouping = (0, express_async_handler_1.default)(async (req, res) => {
    const { fromDate, toDate, companyName } = req.query;
    const matchQuery = {};
    if (fromDate || toDate) {
        matchQuery.createdAt = {};
    ...
    const groupedData = await Booking_1.default.aggregate([
        { $match: matchQuery },
        {
            $lookup: {
                from: 'primarycontacts',
